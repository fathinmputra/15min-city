...
type CorridorRouteRepository interface {
	...
	GetCorridorRouteByRoute(ctx context.Context, route string) ([]entity.Corridor_Route, errs.ErrMessage)
	GetCorridorRouteByDirection(ctx context.Context, direction string) ([]entity.Corridor_Route, errs.ErrMessage)
